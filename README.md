...
Any AVR with flash greater than 4kB should be compatible with VUSB and this project. I've tested it with ATMEGA328AU and ATMEGA168-20MU , both at 16Mhz  and 5V VCC. Those chips come on the pcb of [Arduino Pro Mini China Clones](Pictures/ArduinoProMini.png) that are sold on ebay. One should be able to compile the program for 12Mhz-20Mhz clocks, as long as the Make File is configured acordingly and the SPI clock devider in main.c is set to produce [500kHz SPI](Pictures/SPI.PNG). This is the max SPI frequency the PSX/PS2 controller can handle.
